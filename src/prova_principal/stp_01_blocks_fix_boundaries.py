#0src/prova/principal/1_blocks_fix_boundaries
...
def blocks_batch(base_dir: Path):
    ...
    for test_folder in sorted(base_dir.iterdir()):
        ...
        # --- CHANGE IS HERE ---
        # 1. Define the output directory path inside the current test folder.
        output_dir = test_folder / "prova_principal"
        
        # 2. Create the 'prova_principal' directory if it doesn't already exist.
        output_dir.mkdir(exist_ok=True)
        
        # 3. Set the output file path to be inside the new directory.
        md_out = output_dir / "full_blocks.md"
        # --- END OF CHANGE ---
